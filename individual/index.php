...
$type=[
    [
        'name'=>'Forest',
        'pictureLink'=>'http://dndspeak.com/wp-content/uploads/2018/01/d5c005c366794c6e6cb229788b5eadb0.jpg',
        'encounters'=>[
...
"The party comes across a Dwarven homestead in a little valley where they harvest maple syrup."        
    ...
    [
        'name'=>'Desert',
        'pictureLink'=>'http://dndspeak.com/wp-content/uploads/2018/01/artwork-1517322609239-9460.jpg',
        'encounters'=>[
        ...
        <div class="jumbotron">
            ...
            <?php
                ...
                foreach($type as $value){
                    echo '<center><a class="btn btn-primary btn-lg" href="detail.php?id='.$i.'" role="button" align="center">'.$value['name'].'</a></center></br>';
                    //echo '</br>';
                    $i++;
                }
            ?>
